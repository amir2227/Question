...
public class Question {
    ...
    public Question(String title, String content, String img, Float reward_amount, String reward_unit,
            Integer expire_date, Boolean is_active, Boolean hide_answers, Boolean is_valide, String[] tags,
            User owner) {
        this.title = title;
